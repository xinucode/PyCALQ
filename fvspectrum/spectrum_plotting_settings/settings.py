...
alphabetical = {'A1g':0.01107,'F1':0.0601,'F2':0.0602,'G': 0.07,'G1': 0.0701,'G1g': 0.07107,'G1u': 0.07121,'G2': 0.0702, 
                'Hg': 0.0807, 'Hu': 0.0821, 'T1g':0.20107, 'A1g':0.01107, 'A1gm':0.0110713, 'A2g':0.01207, 'A1u':0.01121, 
                'A2u':0.01221, 'Eg':0.0507, 'Eu':0.0521, 'T1u':0.20121, 'T2g':0.20207, 'T2u':0.20221, 'A1':0.011, 'A2':0.012, 
                'B1':0.021, 'B2':0.022, 'E':0.05}

#latex format of all irreps and particles
latex_format = {'A1g':r"$A_{1g}$", 'A1um':r"$A_{1u}^{-}$", 'A2m':r"$A_{2}^{-}$",'A1gm':r"$A_{1g}^{-}$", 'F1':r"$F_1$", 'F2':r"$F_2$", 
                'G': r'$G$', 'G1':r"$G_1$", 'G1g':r"$G_{1g}$", 'G1u':r"$G_{1u}$", 'G2':r"$G_2$", 'Hg':r"$H_{g}$", 'Hu':r"$H_{u}$", 
                'N': r'$N$', 'pi':r"$\pi$", 'T1g':r"$T_{1g}$", 'A1u':r"$A_{1u}$", 'A2u':r"$A_{2u}$", 'Eg':r"$E_{g}$", 'Eu':r"$E_{u}$", 
                'T1u':r"$T_{1u}$", 'T2g':r"$T_{2g}$", 'T2u':r"$T_{2u}$", 'A1':r"$A_1$", 'A2':r"$A_2$", 'B1':r"$B_1$", 'B2':r"$B_2$", 
                'E':r"$E$", 'S':r"$\Sigma$", 'k':r"$\bar{K}$", 'L': r"$\Lambda$", 'X': r"$\Xi$"}
