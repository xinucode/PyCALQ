    ...
    if fit_info.sim_fit: 
        ...
        if 'scattering_fit_info' in extra_options:
            ...
            for i, scat_fit_info in enumerate(extra_options['scattering_fit_info']):
                ...
                prior_width_multiplier = 5.0
                sh_priors = {
                  #D200
                  "P000A1um1SS0T8-35": {
                    "FirstEnergy": {"Mean":0.0653379277822,"Error":0.000253724085784},
                    "FirstAmplitude": {"Mean":1169.2239226,"Error":6.96630388918},
                    "SqrtGapToSecondEnergy": {"Mean":0.521693761179,"Error":0.0383172625071},
                    "SecondAmplitudeRatio": {"Mean":0.156787476959,"Error":0.0367972642402},
                  },
                  "K000A1u1SS0T8-35": {
                    "FirstEnergy": {"Mean":0.155957822867,"Error":0.000173198662976},
                    "FirstAmplitude": {"Mean":600.854182532,"Error":2.87472240169},
                    "SqrtGapToSecondEnergy": {"Mean":0.490622860183,"Error":0.0163396166601},
                    "SecondAmplitudeRatio": {"Mean":0.327479237459,"Error":0.0226393764217},
                  },
                  "20000G1g-N[SS0]-0T10-25": {
                    "FirstEnergy": {"Mean":0.314290654908,"Error":0.00366897011882},
                    "FirstAmplitude": {"Mean":0.0543509286276,"Error":0.00422390497507},
                    "SqrtGapToSecondEnergy": {"Mean":0.476244595627,"Error":0.034116816566},
                    "SecondAmplitudeRatio": {"Mean":1.69666903558,"Error":0.186101776423},
                  },
                  "3-1000G1g-S[SS0]-0T10-25": {
                    "FirstEnergy": {"Mean":0.383032259747,"Error":0.00193677762274},
                    "FirstAmplitude": {"Mean":0.0730132545349,"Error":0.00300697645611},
                    "SqrtGapToSecondEnergy": {"Mean":0.476973527964,"Error":0.0242269143344},
                    "SecondAmplitudeRatio": {"Mean":1.36249649331,"Error":0.111280869601},
                  },
                  #C103
                  "20000G1g-N-SS_0-0T6-25": {
                    "FirstEnergy": {"Mean":0.702646965314,"Error":0.000362419052005},
                    "FirstAmplitude": {"Mean":0.398564036187,"Error":0.00189177148747},
                    "SqrtGapToSecondEnergy": {"Mean":0.681067565562,"Error":0.0331912338198},
                    "SecondAmplitudeRatio": {"Mean":0.448071884644,"Error":0.0877390915229},
                  },
                  "20p1G1-N-SS_0-0T6-25": {
                    "FirstEnergy": {"Mean":0.714408699881,"Error":0.000309581585447},
                    "FirstAmplitude": {"Mean":2.17874583083,"Error":0.00855589752657},
                    "SqrtGapToSecondEnergy": {"Mean":0.691517798892,"Error":0.0304943938878},
                    "SecondAmplitudeRatio": {"Mean":0.470276521536,"Error":0.090271380638},
                  },
                  "20p2G-N-SS_0-0T6-25": {
                    "FirstEnergy": {"Mean":0.726146049156,"Error":0.000290254537523},
                    "FirstAmplitude": {"Mean":3.97032987015,"Error":0.0144322878565},
                    "SqrtGapToSecondEnergy": {"Mean":0.706509764118,"Error":0.0304021669473},
                    "SecondAmplitudeRatio": {"Mean":0.507332435186,"Error":0.102216298302},
                  },
                }
                ...
                for param in this_xml.findall('Model/*'):
                    if param.tag!="Type":
                      ...
                      # ET.SubElement( new_prior_xml, "Name").text = param.find("Name").text
                      # ET.SubElement( new_prior_xml, "IDIndex").text = param.find("IDIndex").text
                      ET.SubElement( new_prior_xml, "Mean").text = str(sh_priors[param.find("Name").text][param.tag]["Mean"])
                      ET.SubElement( new_prior_xml, "Error").text = str(prior_width_multiplier*sh_priors[param.find("Name").text][param.tag]["Error"])
                ...
                if fit_info.model==general.sigmond_info.fit_info.FitModel.TimeForwardDoubleExpRatio1:
                    ...
                    # ET.SubElement( prior_xml2, "Mean").text = str(fit_info.initial_params[f'SH{i+1}Energy'])
                    # ET.SubElement( prior_xml2, "Error").text = str(prior_width_multiplier*fit_info.initial_params[f'SH{i+1}EnergyError'])
                    # prior_xml2 = ET.SubElement( prior_xml, "FirstAmplitude")
                    # ET.SubElement( prior_xml2, "Mean").text = str(fit_info.initial_params[f'SH{i+1}Amp'])
                    # ET.SubElement( prior_xml2, "Error").text = str(prior_width_multiplier*fit_info.initial_params[f'SH{i+1}AmpError'])
                    # prior_xml2 = ET.SubElement( prior_xml, "SqrtGapToSecondEnergy")
                    # ET.SubElement( prior_xml2, "Mean").text = str(fit_info.initial_params[f'SH{i+1}Gap'])
                    # ET.SubElement( prior_xml2, "Error").text = str(prior_width_multiplier*fit_info.initial_params[f'SH{i+1}GapError'])
                    # prior_xml2 = ET.SubElement( prior_xml, "SecondAmplitudeRatio")
                    # ET.SubElement( prior_xml2, "Mean").text = str(fit_info.initial_params[f'SH{i+1}GapAmp'])
                    # ET.SubElement( prior_xml2, "Error").text = str(prior_width_multiplier*fit_info.initial_params[f'SH{i+1}GapAmpError'])
